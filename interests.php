...
<body>
  ...
  <header class="hero">
      <div class="container text-center">
          ...
          <p class="lead">Tell us about your interests to personalize your AI Tools Hub experience.</p>
      </div>
  </header>
      ...
      <section class="my-5">
          <div class="row">
              <div class="col-lg-8 mx-auto">
                  <div class="card">
                      <div class="card-body">
                          <h2 class="card-title text-center mb-4">Select Your Interests</h2>
...
<div class="mb-3">
    ...
    <input type="hidden" name="interestId" id="interestId">
                              ...
                              <div class="text-center">
                                  <button type="submit" class="btn btn-primary" name="interestSubmit">Save Interests</button>
                              </div>
                          </form>
                      </div>
                  </div>
